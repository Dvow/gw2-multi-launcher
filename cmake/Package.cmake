...
WizardStyle=modern
SetupIconFile=@CMAKE_SOURCE_DIR@/src/icons/gw2-multi-launcher.ico
...
begin
  ...
  add_custom_command(OUTPUT "${setup_file}"
    ...
    DEPENDS ${setup_dependencies} "${CMAKE_BINARY_DIR}/setup.iss" src/icons/gw2-multi-launcher.ico
  ...
  install(FILES src/icons/gw2-multi-launcher.bmp DESTINATION ${CMAKE_INSTALL_LIBDIR}/gw2-multi-launcher)
